...
plot_trial(trials, trial_number=4, channel=2, freqs=freqs)
plot_trial(trials, trial_number=4, channel=3, freqs=freqs)
plot_trial(trials, trial_number=4, channel=4, freqs=freqs)
plot_trial(trials, trial_number=4, channel=5, freqs=freqs)
plot_trial(trials, trial_number=4, channel=6, freqs=freqs)
plot_trial(trials, trial_number=4, channel=7, freqs=freqs)
plot_trial(trials, trial_number=4, channel=8, freqs=freqs)